...
import info.lamatricexiste.network.Utils.HelpSysPerformance;
...
/*		} else {
		...
		mLButtonRecord.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View arg0) {
				...
				Toast.makeText(ActivityMain2.this, getString(id), Toast.LENGTH_SHORT).show();
				return true;
			}
		});
		...
		mLMenu.findViewById(R.id.LHelp).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				mPWMenu.dismiss();
				startActivity(new Intent(ActivityMain2.this, ActivityHelp.class));
			}
		});
		...
		mLMenu.findViewById(R.id.LAbout).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				mPWMenu.dismiss();
				startActivity(new Intent(ActivityMain2.this, ActivityAbout.class));
			}
		});
...
//				mIVSettingsBG.getLayoutParams().height = settingsHeight;
		...
		mLGraphicSurface.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View arg0) {
				Toast.makeText(ActivityMain2.this, getString(R.string.menu_settings_description), Toast.LENGTH_SHORT).show();
				return true;
			}
		});
...
//				yBottom = (int) (getHeight()*0.88);
		...
		mBChooseProcess.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent i = new Intent(ActivityMain2.this, ActivityProcesses.class);
		...
		mCloseSettings.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ActivityMain2.this.intervalRead != intervalRead) {
				...
				ActivityMain2.this.intervalRead = intervalRead;
				ActivityMain2.this.intervalUpdate = intervalUpdate;
				ActivityMain2.this.intervalWidth = intervalWidth;
		...
		/*if (((float) (time - mPrefs.getLong(C.welcomeDate, 1)) / (24 * 60 * 60 * 1000) > 4
			...
			if (v != null) { // This is to avoid a null pointer when the second time this code is executed (findViewById() returns the view only once)
				...
				(mLFeedback.findViewById(R.id.BFeedbackDone)).setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						mPrefs.edit().putBoolean(C.feedbackDone, true).commit();
						Toast.makeText(ActivityMain2.this, getString(R.string.w_main_feedback_done_thanks), Toast.LENGTH_SHORT).show();
						mLFeedback.animate().setDuration(animDuration).setListener(new AnimatorListenerAdapter() {
							@Override
							public void onAnimationEnd(Animator animation) {
								((ViewManager) mLFeedback.getParent()).removeView(mLFeedback);
				...
				(mLFeedback.findViewById(R.id.BFeedbackNo)).setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						mPrefs.edit().putLong(C.welcomeDate, Calendar.getInstance(TimeZone.getTimeZone(C.europeLondon)).getTimeInMillis()).commit();
						Toast.makeText(ActivityMain2.this, getString(R.string.w_main_feedback_no_remind), Toast.LENGTH_LONG).show();
					}
				});
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case ActivityDiscovery.MENU_HELP:
				startActivity(new Intent(ctxt, HelpSysPerformance.class));
				return true;
